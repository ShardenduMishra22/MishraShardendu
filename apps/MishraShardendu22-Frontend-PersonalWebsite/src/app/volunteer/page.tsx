            ...
            <div className="flex items-center gap-3 sm:gap-4 lg:gap-6 flex-shrink-0 w-full lg:w-auto">
              ...
              <div className="flex items-center gap-2 sm:gap-4 flex-1 lg:flex-initial">
                <div className="flex items-center gap-1.5 sm:gap-2">
                  ...
                  <h1 className="text-base sm:text-lg lg:text-2xl font-heading font-bold bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent whitespace-nowrap">
