...
export const metadata: Metadata = {
  ...
  description:
    'Portfolio of Shardendu Mishra - Software Engineer passionate about Go, AI, and building impactful tools. Explore projects, experience, and technical insights.',
  ...
  openGraph: {
    ...
    description:
      'Portfolio of Shardendu Mishra - Software Engineer passionate about Go, AI, and building impactful tools.',
    images: [
      {
...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Portfolio of Shardendu Mishra - Software Engineer passionate about Go, AI, and building impactful tools. Explore projects, experience, and technical insights."
    />
    <meta
      name="keywords"
      content="Shardendu Mishra, Software Engineer, Web Developer, Go, TypeScript, React, Next.js, Portfolio, AI"
    />
    ...
    <meta
      ...
      content="Portfolio of Shardendu Mishra - Software Engineer passionate about Go, AI, and building impactful tools."
    />
...
<meta
  property="og:image"
  content="https://mishrashardendu22.is-a.dev/blog/images/featured-image.jpg"
/>
